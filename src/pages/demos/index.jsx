  ...
  return (
    <DarkTheme>
      ...
      <header
        ...
        style={{ backgroundImage: "url(/img/demos/bg1.jpeg)" }}
        data-overlay-dark="4"
      >
          ...
          <div className="row justify-content-center">
            <div className="col-lg-9 col-md-11 static">
              <div className="capt mt-50">
                <div className="parlx">
                  <h2 className="custom-font">Junior Wembopa Portfolio</h2>
                  <p>
                    Le meilleur moyen de voir mes projects.
                  </p>
                </div>
        ...
        <section className="masonery section-padding sub-bg">
          <div className="container-fluid">
            <div className="sec-head custom-font text-center">
              ...
              <span className="tbg">Page {`D'accueil`}</span>
            </div>
...
{/* 
                ...
                <div className="col-lg-4 col-md-6 items brand">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <img src="/img/demos/21.png" alt="image" />
                  </div>
                  <div className="cont">
                    <h6>Freelance</h6>
                  </div>
        ...
        >
           <div className="container-fluid">
            <div className="sec-head custom-font text-center">
              ...
              <span className="tbg">Portfolio Projet</span>
            </div>
